    ...
    def create_buttons(self):
        button_data = [
            ("Basic Status", [
                ...
                ("Return to Zero (X)", 0x21010C05),
                ("Stand Up / Lie Down (Z)", 0x21010202),
                ("In-Place Mode", 0x21010D05),
            ...
            ("Actions", [
                ...
                ("Backflip", 0x21010502),
                ("Wave", 0x21010507),
                ("Forward Jump", 0x2101050B),
                ("Twist Jump", 0x2101020D),
            ]),
            ("Movement", [
                ("Forward (W)", 0x21010130, 15000, 0),
                ("Backward (S)", 0x21010130, -15000, 0),
                ("Strafe Left (A)", 0x21010131, -30000, 0),
                ("Strafe Right (D)", 0x21010131, 30000, 0),
